...
**穷尽 Exhaustive** 是否整个系统（即 {\textstyle n}{\textstyle n}=all) 是否被捕获或记录。大数据可能包括也可能不包括来自来源的所有可用数据。
...
业务分析能力：可以将业务目标转化为数据分析目标；熟悉常用算法和数据结构，熟悉企业数据库构架建设；针对不同分析主体，可以熟练的进行维度分析，能够从大数据中搜集并提取信息；通过相关数据分析方法，结合一个或多个数据分析软件完成对大数据的处理和分析。<br>
